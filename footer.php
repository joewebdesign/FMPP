        <footer id="footer">
            ...
            <div class="footer-info">
                <div class="container">
                    ...
                    <?php endif; ?>    
                   <?php /*?> <?php wp_nav_menu( array('theme_location' => 'secondary-menu', 'container'  => false, 'menu_id' => 'footer-menu', 'menu_class' => 'footer-links', 'fallback_cb' => 'dt_theme_footer_navigation')); ?><?php */?>
                </div>
            </div>
        </footer>
    </div>
